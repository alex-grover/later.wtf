      ...
      >
        <ConnectKitProvider
          ...
          customTheme={{
            ...
            '--ck-body-background-secondary': 'var(--foreground-secondary)',
            '--ck-body-background-tertiary': 'var(--foreground-secondary)',
            '--ck-tertiary-button-background': 'var(--foreground-tertiary)',
